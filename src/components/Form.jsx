    ...
    return (
        <div className='pr-6 md:pr-12 lg:pr-24 dark:text-white'>
            ...
            <form onSubmit={handleSubmit} className='inline-table tracking-wide'>
                <input className='dark:bg-[#272727] bg-white w-full px-2 py-2 m-2 rounded-2xl shadow-[0_3px_10px_rgb(0,0,0,0.2)]' type="text" placeholder={t('contact.name')} onChange={(e) => setName(e.target.value)} value={name} />

                <input className='dark:bg-[#272727] bg-white w-full px-2 py-2 m-2 rounded-2xl shadow-[0_3px_10px_rgb(0,0,0,0.2)]' type="email" placeholder={t('contact.email')} onChange={(e) => setEmail(e.target.value)} value={email} />

                <textarea className='dark:bg-[#272727] bg-white w-full px-2 py-5 max-h-64 min-h-20 m-2 rounded-2xl shadow-[0_3px_10px_rgb(0,0,0,0.2)]' placeholder={t('contact.messagem')} onChange={(e) => setMessage(e.target.value)} value={message}></textarea>
