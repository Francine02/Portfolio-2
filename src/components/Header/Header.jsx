...
export function Header() {
  ...
  return (
    <header className="flex justify-between py-4 2xl:py-8 items-center">
      <h1 className="text-xl sm:text-2xl lg:text-3xl font-black leading-snug text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-pink-600 to-purple-600">
        Francine
      </h1>
