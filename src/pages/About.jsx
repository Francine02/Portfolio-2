...
export function About() {
  ...
  return (
    <ShineBorder
      className=" mx-7 sm:mx-12 lg:mx-24 2xl:mx-72 dark:bg-[#272727] p-6 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]"
      color={['#4F46E5', '#DB2777', '#9333EA']}
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 items-center">
        <div>
          <h1
            id="sobre"
            className="text-2xl sm:text-3xl md:text-4xl font-semibold dark:text-white text-center pb-10"
          >
